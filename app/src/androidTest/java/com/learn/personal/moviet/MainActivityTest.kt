...
class MainActivityTest {
    ...
    fun testSelectMovie_ShowMovieDetail() {
        onView(withId(R.id.movieRv)).perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(5, click()))
    ...
    fun loadFavouriteSecond(){
        onView(withId(R.id.heart)).perform(ViewActions.click())
        onView(withId(R.id.rv_favourite_movie))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))


        onView(withId(R.id.rv_favourite_movie)).perform(RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(5))

        onView(withId(R.id.rv_favourite_movie)).perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(0, ViewActions.click()))
    }
